...
[fitResults1, ignoreArg1, mu1] = polyfit(xdata1, ydata1, 8);
% 计算多项式
...
% 绘制拟合图
fitLine1 = plot(xplot1,yplot1,'DisplayName','   8 次','Parent',axes1,...
    'Tag','8th degree',...
    'Color',[1 0 0]);
...
set(legend1,...
    'Position',[0.634523809523808 0.86031746031746 0.173214285714286 0.1]);
