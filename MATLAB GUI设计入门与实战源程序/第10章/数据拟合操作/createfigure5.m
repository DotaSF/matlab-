...
[fitResults1, ignoreArg1, mu1] = polyfit(xdata1, ydata1, 6);
% 计算多项式
...
% 绘制拟合图
fitLine1 = plot(xplot1,yplot1,'DisplayName','   6 次','Parent',axes1,...
    'Tag','6th degree',...
    'Color',[0 0 1]);
...
set(legend1,...
    'Position',[0.609523809523808 0.862698412698413 0.173214285714286 0.1]);
